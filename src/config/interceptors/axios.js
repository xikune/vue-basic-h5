...
class AxiosInterceptor {
  requestSuccessFunc(requestObj) {
    CONSOLE_REQUEST_ENABLE && console.warn('【request-interceptor】', `url: ${requestObj.url}`,
      requestObj)
  ...
  responseSuccessFunc(responseObj) {
    ...
    switch (code) {
      ...
      default:
        ...
        !responseObj.config.noShowDefaultError && GLOBAL.vbus.$emit('business.response.incorrect',
          resData.msg);
